...
```bash
curl -sSL https://raw.githubusercontent.com/davidpacold/airia-infrastructure-validation/main/helm/airia-infrastructure-validation/examples/basic-values.yaml \
  -o my-values.yaml
```

Or see the [example values file](../../helm/airia-infrastructure-validation/examples/basic-values.yaml) directly.
...
```bash
helm template airia-infrastructure-validation \
  oci://ghcr.io/davidpacold/airia-infrastructure-validation/charts/airia-infrastructure-validation \
  -f my-values.yaml \
...
```bash
kubectl logs -f -n airia -l app.kubernetes.io/name=airia-infrastructure-validation
kubectl describe pod -n airia -l app.kubernetes.io/name=airia-infrastructure-validation
```
...
# Rollback
helm rollback airia-infrastructure-validation -n airia
...
- Pod logs: `kubectl logs -n airia -l app.kubernetes.io/name=airia-infrastructure-validation`
